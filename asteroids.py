...
class Asteroids(GameObject):
  ...
  def _initModel(self):
      ...
      # Add asteroids specific initialization
  ...
  def update(self, dt):
      """
      There's no way to update the asteroids now because
      all model matrices are sent at initialization
      """
      return
  ...
  def _createAsteroids(self):
	...
	#translation displace along circle 
        #also random rotation around the axes
